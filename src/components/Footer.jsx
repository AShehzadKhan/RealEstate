      ...
      <div className="container mx-auto flex flex-col md:flex-row justify-between items-center">
        <div className="w-full md:w-1/3 mb-8 md:mb-0">
          ...
          <p className="text-gray-400 mt-4">
            ...
            architecto repellendus vel laborum similique exercitationem
            voluptatum accusantium dolores excepturi.
          </p>
        </div>
        ...
        />
        <button className="py-2 rounded px-4  bg-blue-500 text-white cursor-pointer">Subscribe</button>
          </div>
        </div>
      </div>
